...
const variantClasses = {
  default: 'bg-background-card border border-border-default shadow-sm',
  elevated: 'bg-background-card shadow-md hover:shadow-lg',
  selectable: `bg-background-card border-2 cursor-pointer ${
    selected
