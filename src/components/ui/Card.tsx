...
const variantClasses = {
  default: 'bg-gray-200 border border-border-default shadow-lg',
  elevated: 'bg-gray-200 shadow-md hover:shadow-lg',
  selectable: `bg-gray-200 border-2 cursor-pointer ${
    selected
