...
import { ButtonVariant } from '@/src/utils/types';
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', fullWidth = false, className = '', children, disabled, ...props }, ref) => {
    ...
    const variantClasses: Record<ButtonVariant, string> = {
      ...
      outline: 'bg-transparent text-brand-primary border-2 border-brand-primary hover:bg-blue-50 active:bg-blue-100 disabled:bg-gray-100 disabled:text-gray-400 disabled:border-gray-300',
